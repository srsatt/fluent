...
{target-language greeting}, {name}! Time to review items that are due before they fade. This keeps useful language available. 🧠

**Items Due Today:** {count}
**Estimated Time:** ~{minutes} min

Why review? Spaced repetition improves retention and frees attention for real communication.
...
- **Prefer daily.** The system works best when the learner reviews often. If they miss a day, continue from the due queue rather than scolding.
