...
1. **Top 1-2 critical weaknesses** (highest frequency + severity) → about 40% of session time.
2. **Due review items** → about 20% of session time.
3. **One contrast or moderate pattern** → about 20% of session time.
4. **One realistic integration scenario** → about 20% of session time.
...
- **50-75%** → learning zone, keep going
