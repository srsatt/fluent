...
### Example 1 — personal email text (A2)
...
Generate or maintain short text banks per target language and CEFR level. Prefer realistic adult texts: appointment messages, ads, instructions, workplace notes, travel updates, housing posts, short news, and personal emails. Do not reuse the same text in consecutive sessions.
